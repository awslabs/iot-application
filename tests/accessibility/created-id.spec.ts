...
test(' Created ID in Create Dashboard Page Accessibility Test', async ({
  page,
}) => {
  ...
  // Navigate to the create page for the accessibility test
  await page.goto('http://localhost:3000/dashboards/create');
